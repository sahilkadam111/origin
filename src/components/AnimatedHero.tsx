  ...
  return (
    <section className="py-20 relative overflow-hidden">
      ...
      <div className="text-center mb-12 relative z-10 px-6">
        <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 gradient-text tracking-normal leading-relaxed py-2">
          Highlighting The Originals
        </h2>
        <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto">
          Discover our journey through stories, insights, and meaningful conversations
        </p>
      </div>
