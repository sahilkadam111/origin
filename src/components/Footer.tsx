	...
	return (
		<footer className="relative pt-16 pb-8 px-4 md:px-6 bg-background border-t border-border">
					...
					<div className="space-y-4">
						...
						<form onSubmit={handleNewsletterSubmit} className="space-y-4">
							...
							<div className="space-y-2">
								...
								<Button type="submit" className={cn("w-full bg-accent/10 hover:bg-accent/20 text-accent border border-accent/50 transition-all duration-300 hover:shadow-[0_0_20px_rgba(0,200,255,0.2)]")}>Subscribe</Button>
							</div>
						</form>
					</div>
				</div>
			...
			<Button
				onClick={scrollToTop}
				className={cn(
					"fixed bottom-8 right-8 w-12 h-12 rounded-full bg-accent/10 hover:bg-accent/20 border border-accent/50 text-accent transition-all duration-300 hover:shadow-[0_0_20px_rgba(0,200,255,0.2)] opacity-0 pointer-events-none",
